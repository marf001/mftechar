Dashboard de OSINT (Open Source Intelligence) diseñado para la investigación de fuentes públicas argentinas. 
Sin API keys, sin costos, sin restricciones — solo datos públicos organizados para quien los necesita.
